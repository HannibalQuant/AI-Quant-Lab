...
PRECONDITIONS = (
    ...
    _ip(4, "Canonical serialization/ID/hash/equivalence", "AUD-01,DAT-05", "artifacts,data", "ART + DAT", "Approve representation scope", P.PARTIALLY_RESOLVED, "No unsupported lock claim", "", "T04,T36", "PARTIAL: dataset artifacts, real-CSV admission and research-eligibility policy/records persist and reconstruct with exact canonical identity; broader representation authority remains open"),
    ...
    _ip(9, "Validation method specifications", "VAL-01,VAL-02,VAL-03,VAL-04,VAL-05,VAL-06,VAL-07", "VAL", "VAL + GOV", "Approve method scopes", P.PARTIALLY_RESOLVED, "No validation claim outside exact bounded method", "IP-08", "T12,T20,T21,T22", "PARTIAL: one exact pre-specified TOTAL_RETURN trade-bootstrap method has deterministic PASS/FAIL/INCONCLUSIVE, authority binding and lineage; temporal preregistration, holdout evidence, dependence-aware robustness, corrected multiplicity and broader method approval remain open"),
